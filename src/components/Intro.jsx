...
function Intro() {
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-6">
      ...
      Java | C# | Spring Boot | Javascript | PostgreSQL | Oracle SQL | Python | HTML | Git <br />
      TDD | DDD | Azure | Docker | CI/CD | Firebase | Unit Testing | REST | OpenAPI <br /> GitHub Copilot | OOP | WSL |
